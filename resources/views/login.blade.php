            ...
            <div class="login-content">
                ...
                <div class="login-form">
                    <form>
                        ...
                        <button type="submit" class="btn btn-success btn-flat m-b-30 m-t-30"><a href="/dashboard">Sign In</a></button>
                        <div class="social-login-content">
                        </div>
                        <div class="register-link m-t-15 text-center">
                            <p><b>Only Good Bag Community</b> Allowed to Access This Websites</p>
                        </div>
                    </form>
                </div>
            </div>
